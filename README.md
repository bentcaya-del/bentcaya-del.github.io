...
Site one-page codé entièrement à la main (sans framework), avec :

- Loader animé au chargement
- Curseur personnalisé avec halo qui suit la souris
- Animations "scroll reveal" sur les sections
